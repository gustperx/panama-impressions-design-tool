...
use App\DataTables\Scopes\Panel\Users\UserTypeAdmin;
use App\Modules\Auth\AdminHtmlBuilder;
...
class AdminController extends Controller
{
    ...
    public function index(UsersDataTable $dataTable)
    {
        ...
        return $dataTable->addScope(new UserTypeAdmin())
    ...
    public function create()
    {
        ...
        $dynamic    = ['type' => 'open', 'route' => 'users.admin.create', 'title' => "Nuevo Administrador"];
    ...
    public function store(Request $request)
    {
        ...
        Alert::success(trans('users.admin.create', ['name' => $user->fullname]));
    ...
    public function edit(User $user)
    {
        ...
        $dynamic    = ['type' => 'model', 'route' => 'users.admin.update', 'title' => "Actualizar administrador: $user->fullname"];
    ...
    public function update(Request $request, User $user)
    {
        ...
        Alert::info(trans('users.admin.update', ['name' => $user->fullname]));
